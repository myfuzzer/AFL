...
PROGS       = afl-gcc afl-fuzz afl-fuzz-refactor afl-fuzz-refactor afl-showmap afl-tmin afl-gotcpu afl-analyze
...
afl-fuzz-refactor: $(COMM_HDR) | test_x86
	$(CC) $(CFLAGS) src/core/globals.c src/core/queue.c src/core/executor.c src/core/forkserver.c src/utils/timing.c src/utils/random.c src/utils/system.c src/analysis/bitmap.c src/analysis/coverage.c src/io/file_ops.c src/io/stats.c src/mutation/mutation_helpers.c src/mutation/fuzzing_engine.c src/mutation/dictionary.c src/mutation/trimming.c src/mutation/postprocessor.c src/sync/sync.c src/main/main.c -o $@ $(LDFLAGS)
